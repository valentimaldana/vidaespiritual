...
function carregar() {
    window.alert(' VIRE O CELULAR NA POSIÇÂO HORIZONTAL PARA MELHOR VISUALIZAÇÃO >> NOTE: The English version does NOT correspond to the Portuguese version (it is out of date) ')
